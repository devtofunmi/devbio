                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 z-50" onClick={() => setIsMenuOpen(false)}>
                    <div className="fixed top-0 right-0 w-full h-full bg-white shadow-lg" onClick={(e) => e.stopPropagation()}>
                        ...
                        <nav className="pt-20 px-8 flex flex-col space-y-4">
                            <Link href="#features" className="font-bold py-2 border-b border-gray-200 text-xl text-gray-800 hover:text-blue-600 transition" onClick={() => setIsMenuOpen(false)}>Features</Link>
                            <Link href="#testimonials" className="font-bold py-2 border-b border-gray-200 text-xl text-gray-800 hover:text-blue-600 transition" onClick={() => setIsMenuOpen(false)}>Testimonials</Link>
                            <a href="/signup" className="font-bold py-2 border-b border-gray-200 text-xl text-gray-800 hover:text-blue-600 transition" onClick={() => setIsMenuOpen(false)}>
                                Sign Up
                            </a>
                        </nav>
                    </div>
