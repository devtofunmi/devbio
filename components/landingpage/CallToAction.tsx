...
const CallToAction: React.FC = () => (
    <section className="flex flex-col items-center justify-center py-16 px-6 bg-[#f7f9fb]">
        ...
        <Link href="/signup/" className="inline-block rounded-full bg-blue-400 text-white font-bold px-12 py-4 text-xl shadow-lg hover:bg-blue-500 transition transform hover:scale-105">
