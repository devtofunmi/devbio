...
const Features: React.FC = () => {
  const cardClasses = "bg-white p-6 rounded-xl border border-gray-200 transform transition-all duration-300 active:-rotate-2 hover:rotate-2";
  ...
  return (
    <div className="min-h-screen  p-4 md:p-8">
      <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-12 max-w-7xl mx-auto">
        ...
        <div className={`md:col-span-6 ${cardClasses}`}>
        ...
        <div className={`md:col-span-3 ${cardClasses}`}>
          ...
          <div className="flex justify-around items-center h-24 text-4xl text-gray-500">
