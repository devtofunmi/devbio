        ...
        <div className="flex flex-col md:flex-row gap-8 lg:gap-12 items-center">
          <div className="md:w-5/12 w-full transform transition-transform duration-500 hover:scale-105">
            <div className="bg-white p-6 rounded-xl border border-gray-200 w-full">
              <h3 className="font-bold text-2xl text-gray-800 mb-2">Project List</h3>
              <div className="space-y-3 mt-4">
                <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
                  <p className="font-semibold text-xl text-gray-700">Project Alpha</p>
                </div>
                <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
                  <p className="font-semibold text-xl text-gray-700">Project Beta</p>
                </div>
              </div>
            </div>
          </div>
          <div className="md:w-7/12 w-full">
            <h3 className="font-bold text-5xl text-[#cee933] mb-3">Showcase Your Best Work</h3>
        ...
        <div className="flex flex-col md:flex-row-reverse gap-8 lg:gap-12 items-center">
          <div className="md:w-5/12 w-full transform transition-transform duration-500 hover:scale-105">
            <div className="bg-slate-50 p-6 rounded-xl border border-gray-200 w-full">
              <h3 className="font-bold text-2xl text-gray-800 mb-2">Built-in Analytics</h3>
          ...
          <div className="md:w-7/12 w-full">
            <h3 className="font-bold text-5xl text-blue-400 mb-3">Understand Your Audience</h3>
    ...
    <div className="bg-[#860005] py-16 md:py-24 h-screen flex items-center">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row gap-8 lg:gap-12 items-center">
          <div className="md:w-5/12 w-full transform transition-transform duration-500 hover:scale-105">
            <div className="bg-white p-6 rounded-xl border border-gray-200 w-full">
              <h3 className="font-bold text-2xl text-gray-800 mb-2">GitHub Contributions</h3>
          ...
          <div className="md:w-7/12 w-full">
            <h3 className="font-bold text-5xl text-[#cee933] mb-3">Sync Your GitHub Activity</h3>
            <p className="text-white leading-relaxed text-2xl">
    ...
    <div className="bg-gray-800 py-16 md:py-24 h-screen flex items-center">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row-reverse gap-8 lg:gap-12 items-center">
          <div className="md:w-5/12 w-full transform transition-transform duration-500 hover:scale-105">
            <div className="bg-slate-50 p-6 rounded-xl border border-gray-200 w-full">
              <h3 className="font-bold text-2xl text-gray-800 mb-2">Tech Stack Visuals</h3>
              <div className="flex justify-around items-center h-24 text-5xl text-gray-500 mt-4">
          ...
          <div className="md:w-7/12 w-full">
            <h3 className="font-bold text-5xl text-white mb-3">Display Your Expertise</h3>
    ...
    <div className="bg-purple-600 py-16 md:py-24 h-screen flex items-center">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row gap-8 lg:gap-12 items-center">
          <div className="md:w-5/12 w-full transform transition-transform duration-500 hover:scale-105">
            <div className="bg-white p-6 rounded-xl border border-gray-200 w-full">
              <h3 className="font-bold text-2xl text-gray-800 mb-2">Customizable Profile</h3>
          ...
          <div className="md:w-7/12 w-full">
            <h3 className="font-bold text-5xl text-white mb-3">Make It Uniquely Yours</h3>
    ...
    <div className="bg-green-500 py-16 md:py-24 h-screen flex items-center">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row-reverse gap-8 lg:gap-12 items-center">
          <div className="md:w-5/12 w-full transform transition-transform duration-500 hover:scale-105">
            <div className="bg-slate-50 p-6 rounded-xl border border-gray-200 w-full">
              <h3 className="font-bold text-2xl text-gray-800 mb-2">Custom Domains</h3>
              <div className="bg-white p-3 mt-4 rounded-lg border border-gray-200">
                <p className="text-center font-mono text-blue-400 text-3xl">yourname.dev</p>
              </div>
            </div>
          </div>
          <div className="md:w-7/12 w-full">
            <h3 className="font-bold text-5xl text-white mb-3">Own Your Online Identity</h3>
