  ...
  return (
    <div className={`${geistSans.className} ${geistMono.className} flex min-h-screen items-center justify-center bg-white p-4`}>
      <div className="flex flex-col lg:flex-row w-full max-w-6xl rounded-xl">
        ...
        <div className="lg:flex flex-1 items-center justify-center relative bg-white hidden md:block">
            ...
            <div className="relative w-[450px] h-96">
                <div className="absolute top-10 left-5 w-20 h-20 bg-[#20232A] rounded-xl transform -rotate-6 flex items-center justify-center text-[#61DAFB] transition-transform duration-300 hover:-rotate-2 focus:-rotate-2">
                    <SiReact size={40} />
                </div>
                <div className="absolute top-0 right-20 w-16 h-16 bg-[#339933] rounded-full transform rotate-6 flex items-center justify-center text-white transition-transform duration-300 hover:-rotate-2 focus:-rotate-2">
                    <SiNodedotjs size={32} />
                </div>
                <div className="absolute bottom-10 left-0 w-24 h-24 bg-[#47A248] rounded-lg transform rotate-3 flex items-center justify-center text-white transition-transform duration-300 hover:-rotate-2 focus:-rotate-2">
                    <SiMongodb size={60} />
                </div>
                <div className="absolute bottom-5 right-24 w-28 h-28 bg-black rounded-xl flex items-center justify-center text-white transition-transform duration-300 hover:-rotate-2 focus:-rotate-2">
                    <SiNextdotjs size={60} />
                </div>
                <div className="absolute bottom-0 right-0 w-20 h-20 bg-[#06B6D4] rounded-full flex items-center justify-center text-white transition-transform duration-300 hover:-rotate-2 focus:-rotate-2">
                    <SiTailwindcss size={40} />
                </div>
                <div className="absolute top-24 right-0 w-16 h-16 bg-gray-800 rounded-full transform -rotate-12 flex items-center justify-center text-white transition-transform duration-300 hover:-rotate-2 focus:-rotate-2">
                    <SiGithub size={40} />
                </div>
                <div className="absolute top-40 left-16 w-14 h-14 bg-[#1DA1F2] rounded-full transform rotate-12 flex items-center justify-center text-white transition-transform duration-300 hover:-rotate-2 focus:-rotate-2">
                    <SiX size={28} />
                </div>
                <div className="absolute bottom-24 right-0 w-16 h-16 bg-[#0A66C2] rounded-lg transform -rotate-12 flex items-center justify-center text-white transition-transform duration-300 hover:-rotate-2 focus:-rotate-2">
                    <SiLinkedin size={32} />
                </div>
                <div className="absolute top-20 left-32 w-52 h-24 bg-gray-100 p-2 rounded-lg transform rotate-3 transition-transform duration-300 hover:-rotate-2 focus:-rotate-2">
